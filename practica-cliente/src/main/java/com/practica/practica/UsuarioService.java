...
public class UsuarioService{
    ...
    public void putUsuario(int usuarioId, String nombre, String matricula, Date fechaNacimiento, String correoElectronico) {
        Usuario usuario = new Usuario();
    ...
    public void getUsuarios(int page, int size) {
        PageUsuario usuarios = clienteWeb.get()
